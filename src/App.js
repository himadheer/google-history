...
class App extends Component {
  ...
  onDeleteHistory = id => {
    const {HistoryList, e} = this.state
  ...
  render() {
    const {searchInput, HistoryList, e} = this.state
    const searchHistoryResults = HistoryList.filter(each =>
    ...
    return (
      <div className="bg-container">
          ...
          <div className="input-bg-container">
            ...
            <div className="input-container">
              <input
                ...
                onChange={this.searchHistoryInput}
              />
            </div>
          </div>
        </nav>
        ...
        {e && <p className="empty-heading">There is no history to show</p>}
      </div>
    )
  }
}
